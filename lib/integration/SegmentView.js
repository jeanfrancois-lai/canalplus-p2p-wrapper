...
class SegmentView {
    ...
    */
    static fromArrayBuffer(arrayBuffer) {
        ...
        let u32buffer = u8data.slice(0, 8).buffer;
        let u32data = new Uint32Array(u32buffer);
        let [adaptationId, representationId] = u32data;

        let f64buffer = u8data.slice(8).buffer;
    ...
    /**
      ...
      */
    toArrayBuffer() {
        let u32data = new Uint32Array([this.trackView.adaptationId, this.trackView.representationId]);
        ...
        array.set(new Uint8Array(f64data.buffer), 8);
